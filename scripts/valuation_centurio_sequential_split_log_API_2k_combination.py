...
YAML_PATH = os.path.join("./autotask", "config_combination.yaml")
...
if __name__ == '__main__':
    ...
    for i in range(31,33):
        save_path = config["save_path"]
        log_name = "{}_API_2k_{}_{}_all_true_vlaue_02.json".format(config["llm_name"], str(i), datetime.now().strftime('%m%d%H%M'))
        ...
        for j in range(1):
            ...
            answer_test = qad['gt_plan_answer_one']
            # 获得end2end的结果
            final_action = agent(instruction, answer_test)
