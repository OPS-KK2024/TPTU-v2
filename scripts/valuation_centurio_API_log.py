...
# !/usr/bin/env python
# -*- coding: utf-8 -*-
from autotask.agent.onestep_centurio_API import CenturioAgent
import json
import os
...
if __name__ == '__main__':
    ...
    log_name = "{}_{}_{}_2k.json".format(config["llm_name"], config["log_name"], datetime.now().strftime('%Y_%m_%d_%H_%M_%S'))
