...
class ChatGPT():
    def __init__(self, config) -> None:
        ...
        print('**** ChatGPT has been successfully initialized ****')
    ...
    def __call__(self, query: str, stop: Optional[List[str]] = None) -> str:
        ...
        print('ChatGPT response ==>', eval(response.text))
        message = eval(response.text)['choices'][0]['message']['content']
