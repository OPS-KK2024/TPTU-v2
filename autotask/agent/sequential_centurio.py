from autotask.prompt.prompt_centurio import Centurio_Prompt
        ...
        if 'mode' in self.config:
            if self.config['mode'] == 'test':
                ...
                while True:
                    ...
                    try:
                        print("================================START================================")
                        action_prompt = self.prompt.sys_prompt().format(question=instruction)
                        # print(action_prompt)
